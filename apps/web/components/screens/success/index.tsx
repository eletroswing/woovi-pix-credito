...
function Success() {
    ...
    return (
        <main className="flex justify-center items-center w-full h-[100vh] bg-woovi-green text-[#fff]">
            <audio src="/success.mp3" ref={audio} />
            <div>
                <svg viewBox="0 0 377 144" width={200} >
                    <g fill="currentColor">
